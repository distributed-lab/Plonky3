...
mod tests {
    ...
    fn bls12337_from_str(input: String) -> Bls12_377Fr {
        Bls12_377Fr::from_str(&input).unwrap()
    }
    ...
    lazy_static! {
        static ref test_cases: Vec<TestCase> = vec![
            TestCase{
                ...
                output: [
                    Bls12_377Fr::from_str("860866526687489428989707845699174300428968972136191802628058085350960837665").unwrap(),
                    Bls12_377Fr::from_str("5110597475731104621758769815158117224808582320756097893691034814235891573903").unwrap(),
                    Bls12_377Fr::from_str("7729317803422720288984283127941214463170714974376170076017011151108586598169").unwrap(),
                ],
            },
            TestCase{
                input: [
                ...
                output: [
                    Bls12_377Fr::from_str("675583857530871455730788450062580113099802122446214910490159210203931204829").unwrap(),
                    Bls12_377Fr::from_str("5907675690176137521797568886899101531719052562432127804242792579253736799082").unwrap(),
                    Bls12_377Fr::from_str("3580163914861780974242579068588450174896166405220547377222985096420674645846").unwrap(),
                ],
            },
            TestCase{
                input: [
                ...
                output: [
                    Bls12_377Fr::from_str("3055206294377317359307613780575828874003458762314725501486826284300578105158").unwrap(),
                    Bls12_377Fr::from_str("5797369338536356401300628927961554112193154358645694251738402018195827090483").unwrap(),
                    Bls12_377Fr::from_str("6809256165826541738832209298614382604751407820145487553453583098940097598887").unwrap(),
                ],
            },
        ];
    }
