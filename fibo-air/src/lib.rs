...
pub fn fibonacci_bn254_test(log_n: usize, n: usize, res: u32) {
    ...
    let trace = generate_fibonacci_trace::<Bn254Fr>(n);
    // println!("trace: {:?}", trace);
...
mod tests {
    ...
    use crate::{fibonacci_bn254_test};
