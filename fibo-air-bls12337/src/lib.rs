...
pub fn fibonacci_bls12337_test(log_n: usize, num_steps: usize, final_value: u64) {
    ...
    let trace = generate_fibonacci_trace::<Bls12377Fr>(num_steps);
    // println!("trace: {:?}", trace);
...
mod tests {
    ...
    use crate::fibonacci_bls12337_test;
